...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya ucheta zayavok v i t kompanii корма l');

test('testing i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-корма-l', function(assert) {
