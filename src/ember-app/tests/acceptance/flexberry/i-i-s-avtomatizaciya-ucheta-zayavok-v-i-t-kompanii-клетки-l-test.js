...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya ucheta zayavok v i t kompanii клетки l');

test('testing i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-клетки-l', function(assert) {
