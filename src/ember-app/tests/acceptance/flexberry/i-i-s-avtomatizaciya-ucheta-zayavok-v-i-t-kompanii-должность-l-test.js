...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya ucheta zayavok v i t kompanii должность l');

test('testing i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-должность-l', function(assert) {
