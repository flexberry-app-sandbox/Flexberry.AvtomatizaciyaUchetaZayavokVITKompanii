...
moduleForModel('i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-животные', 'Unit | Serializer | i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-животные', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-животные',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
