...
moduleForModel('i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-должность', 'Unit | Serializer | i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-должность', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-должность',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
