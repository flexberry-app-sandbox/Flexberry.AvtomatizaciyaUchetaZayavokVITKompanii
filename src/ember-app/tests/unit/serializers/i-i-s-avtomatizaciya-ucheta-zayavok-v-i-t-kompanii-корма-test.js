...
moduleForModel('i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-корма', 'Unit | Serializer | i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-корма', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-корма',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
