...
moduleForModel('i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-сведения', 'Unit | Serializer | i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-сведения', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-сведения',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
