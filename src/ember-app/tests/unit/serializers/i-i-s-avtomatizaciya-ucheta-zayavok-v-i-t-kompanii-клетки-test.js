...
moduleForModel('i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-клетки', 'Unit | Serializer | i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-клетки', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-ucheta-zayavok-v-i-t-kompanii-клетки',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
