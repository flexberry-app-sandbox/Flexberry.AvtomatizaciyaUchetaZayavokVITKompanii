    ...
    public class Клетки : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлеткиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлеткиE", typeof(IIS.Avtomatizaciya_ucheta_zayavok_v_IT_kompanii.Клетки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлеткиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлеткиL", typeof(IIS.Avtomatizaciya_ucheta_zayavok_v_IT_kompanii.Клетки));
                }
            }
        }
    }
